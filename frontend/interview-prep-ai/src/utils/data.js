export const CARD_BG = [
  ...
  { id: 7, bgcolor: 'linear-gradient(135deg, #fff4c4 0%, #fffbd8 100%)' },
  { id: 8, bgcolor: 'linear-gradient(135deg, #e8fef3 0%, #f5fffa 100%)' },
...
export const APP_FEATURES = [
  {
    ...
    description:
      "Get interview questions and model answers based on your role, experience, and specific focus areas - no more generic advice!",
  },
  {
    id: "02",
  ...
  },
  {
    ...
    description:
      "Simulate real interview scenarios with timed practice sessions and get instant feedback on your delivery and content.",
  },
];