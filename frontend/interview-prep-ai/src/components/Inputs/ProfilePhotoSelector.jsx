...
export default function ProfilePhotoSelector({image,setImage,preview,setPreview}) {
   ...
   const onChooseFile = () =>{
    ...
    {!image ? (
        ...
        <button
        type='button'
        className='w-8 h-8 items-center justify-center bg-linear-to-r from-orange-500/85 to-orange-600 text-white rounded-full absolute -bottom-1 -right-1 cursor-pointer'
